...
export default function Home() {
  ...
  const calculations = {
    ...
    dailyCO2Grams: () => {
      ...
      // Base calculation: Volume (m³) × Target PPM × 0.0018
      let co2Grams = volume * targetPPM * 0.0018;
      
      // Adjust for ventilation type
      if (state.settings.ventilationType === 'exhausting') {
        co2Grams *= 1.5; // 50% more for active exhaust
      }
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">CO₂ Flow Estimator</h1>
                <p className="text-sm text-gray-600">co2forplants.co.uk</p>
              </div>
            </div>
            <div className="hidden md:flex items-center space-x-4">
              <span className="text-sm text-gray-600">Professional Hydroponics Calculator</span>
              <Button onClick={handleExport} className="bg-primary text-white hover:bg-primary-dark">
      ...
      <main className="container mx-auto px-4 py-8">
        {/* Intro Section */}
        <div className="mb-8">
          <div className="bg-gradient-to-r from-primary to-primary-light text-white rounded-xl p-6 mb-6">
            <h2 className="text-2xl font-bold mb-2">Calculate Your CO₂ Requirements</h2>
            <p className="text-green-100 text-lg">Determine optimal CO₂ levels, flow rates, and cylinder requirements for your grow room with our professional calculator.</p>
          </div>
          
          {/* Safety Alert */}
          <Alert className="bg-orange-50 border-l-4 border-warning">
            <TriangleAlert className="h-4 w-4 text-warning" />
            <AlertDescription className="text-orange-700">
              <span className="font-semibold">Safety First:</span> Always use a CO₂ monitor and ensure proper ventilation. Levels above 1500 ppm can be dangerous.
            </AlertDescription>
          </Alert>
        </div>
          ...
          <div className="bg-card rounded-xl shadow-lg p-6">
            ...
            <div className="space-y-6">
              ...
              <Card className="bg-gray-50">
                <CardContent className="p-4">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      <Label htmlFor="roomLength" className="text-sm font-medium text-gray-700 mb-2">Length (m)</Label>
                      <Input
                        id="roomLength"
                        type="number"
                        placeholder="4.0"
                    ...
                    <div>
                      <Label htmlFor="roomWidth" className="text-sm font-medium text-gray-700 mb-2">Width (m)</Label>
                      <Input
                        id="roomWidth"
                        type="number"
                        placeholder="3.0"
                    ...
                    <div>
                      <Label htmlFor="roomHeight" className="text-sm font-medium text-gray-700 mb-2">Height (m)</Label>
                      <Input
                        id="roomHeight"
                        type="number"
                        placeholder="2.5"
              ...
              <Card className="bg-gray-50">
                <CardContent className="p-4">
                  <h4 className="font-medium text-gray-900 mb-4 flex items-center">
                    <Wind className="text-primary mr-2" />
                    CO₂ Configuration
                  </h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <Label className="text-sm font-medium text-gray-700 mb-2">Target CO₂ Level (ppm)</Label>
                    ...
                    <div>
                      <Label className="text-sm font-medium text-gray-700 mb-2">Ventilation Type</Label>
                  ...
                  <>
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      <div className="bg-blue-50 p-4 rounded-lg text-center">
                        <div className="text-2xl font-bold text-info">{calculations.roomVolume().toFixed(1)}</div>
                        <div className="text-sm text-gray-600">Room Volume (m³)</div>
                      </div>
                      <div className="bg-green-50 p-4 rounded-lg text-center">
                        <div className="text-2xl font-bold text-success">{Math.round(calculations.dailyCO2Grams())}</div>
                        <div className="text-sm text-gray-600">Daily CO₂ (grams)</div>
                      </div>
                    </div>
