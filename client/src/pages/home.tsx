          ...
          <div className="lg:col-span-2">
            <div className="neu-card rounded-3xl p-8">
              ...
              <div className="space-y-8">
                {/* Room Dimensions */}
                <div className="neu-section-dimensions rounded-2xl p-6">
                  <h4 className="font-medium text-neu-light mb-6 flex items-center">
                    <div className="neu-raised rounded-xl p-2 mr-3">
                      <Box className="text-neu-darkest h-5 w-5" />
                    </div>
                    Room Dimensions
                  </h4>
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      <Label htmlFor="roomLength" className="text-sm font-medium text-neu-light mb-2 block">Length (m)</Label>
                      <Input
                        id="roomLength"
                        type="number"
                        placeholder="4.0"
                    ...
                    <div>
                      <Label htmlFor="roomWidth" className="text-sm font-medium text-neu-light mb-2 block">Width (m)</Label>
                      <Input
                        id="roomWidth"
                        type="number"
                        placeholder="3.0"
                    ...
                    <div>
                      <Label htmlFor="roomHeight" className="text-sm font-medium text-neu-light mb-2 block">Height (m)</Label>
                      <Input
                        id="roomHeight"
                        type="number"
                        placeholder="2.5"
                ...
                {/* CO2 Settings */}
                <div className="neu-section-co2 rounded-2xl p-6">
                  <h4 className="font-medium text-neu-light mb-6 flex items-center">
                    <div className="neu-raised rounded-xl p-2 mr-3">
                      <Wind className="text-neu-darkest h-5 w-5" />
                    </div>
                    CO₂ Configuration
                  </h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        <Label className="text-sm font-medium text-neu-light">Target CO₂ Level (ppm)</Label>
                        <div className="group relative">
                          <HelpCircle className="h-4 w-4 text-neu-light cursor-help" />
                    ...
                    <div>
                      <Label className="text-sm font-medium text-neu-light mb-2 block">Ventilation Type</Label>
                ...
                {/* Usage Schedule */}
                <div className="neu-section-schedule rounded-2xl p-6">
                  <h4 className="font-medium text-neu-dark mb-6 flex items-center">
                    <div className="neu-raised rounded-xl p-2 mr-3">
                      <Clock className="text-neu-darkest h-5 w-5" />
                    </div>
                    Usage Schedule
                  </h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor="hoursPerDay" className="text-sm font-medium text-neu-dark mb-2 block">Hours per Day</Label>
                      <Input
                        id="hoursPerDay"
                        type="number"
                        placeholder="12"
                      ...
                      />
                      <p className="text-xs text-neu-dark mt-1">Typically matches light cycle</p>
                      {errors.hoursPerDay && <p className="text-xs text-destructive mt-1">{errors.hoursPerDay}</p>}
                    </div>
                    <div>
                      <Label htmlFor="daysPerWeek" className="text-sm font-medium text-neu-dark mb-2 block">Days per Week</Label>
                      <Input
                        id="daysPerWeek"
                        type="number"
                        placeholder="7"
                      ...
                      />
                      <p className="text-xs text-neu-dark mt-1">Continuous operation recommended</p>
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    {['6kg', '10kg', '20kg'].map((size) => (
                      <button
                        ...
                        className={`neu-cylinder-button flex flex-col items-center p-4 rounded-xl ${
                          state.settings.cylinderType === size ? 'selected' : ''
                        }`}
                      >
                        <Gauge className={`text-2xl mb-2 ${
                          state.settings.cylinderType === size ? 'text-neu-light' : 'text-neu-medium-dark'
                        }`} />
                        <span className="font-medium">{size}</span>
                        <span className={`text-sm ${
                          state.settings.cylinderType === size ? 'text-neu-medium-light' : 'text-neu-medium'
                        }`}>
            ...
            <div className="neu-card rounded-3xl p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button onClick={handleExport} className="neu-button text-neu-darkest px-4 py-2 font-medium">
